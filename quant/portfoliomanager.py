...
class PortfolioManager(object):
    ...
    def __init__(self):
        ...
        self._orders: DefaultDict[str, DefaultDict[str, Order]] = defaultdict(dict) #两级字典
        self._fills: DefaultDict[str, DefaultDict[str, DefaultDict[str, Fill]]] = defaultdict(dict) #三级字典
